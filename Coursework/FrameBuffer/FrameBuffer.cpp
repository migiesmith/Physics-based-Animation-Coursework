...
namespace graphics_framework{
	...
	FrameBuffer::FrameBuffer(const GLuint &width, const GLuint &height) : _bufferWidth(width), _bufferHeight(height){
	...
	void FrameBuffer::createDepthBuffer(const GLuint &width, const GLuint &height){
		...
		*/
		...
		// Set the Depth Buffer to render no colour
		glDrawBuffer(GL_NONE);
		glReadBuffer(GL_NONE);
	}

	void FrameBuffer::createColourBuffer(const GLuint &width, const GLuint &height){
		/*
